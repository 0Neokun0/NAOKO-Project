...
function Header() {
  ...
  console.log("Current These is ", theme);
    ...
    <header className="sticky top-0 z-40 bg-white dark:bg-[#1D2226] flex items-center justify-around py-1.5 px-3 focus-within:shadow-lg">
      ...
      <div className="flex items-center space-x-2 w-full max-w-xs">
        {mounted && (
          <>
            {resolvedTheme === "dark" ? (
              <Image src="https://weblike-upcolor.ssl-lolipop.jp/UpColor/includes/images/Up.png" width={45} height={45} />
            ) : (
              <Image src="https://weblike-upcolor.ssl-lolipop.jp/UpColor/includes/images/Up.png" width={55} height={55} />
            )}
          </>
        )}
